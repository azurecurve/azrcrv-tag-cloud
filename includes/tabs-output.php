...
/*
	...
	assets/css/admin-standard.css and assets/js/admin-standard.js).
*/
...
$tab_settings_label     = esc_html__( 'Settings', 'azrcrv-tc' );
$tab_instructions_label = esc_html__( 'Instructions', 'azrcrv-tc' );
...
<div class="azrcrv-donate">
	<?php esc_html_e( 'Support', 'azrcrv-tc' ); ?>
	...
	<span>
		<?php esc_html_e( 'You can help support the development of our free plugins by donating a small amount of money.', 'azrcrv-tc' ); ?>
	</span>
</div>
