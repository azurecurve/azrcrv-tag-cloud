 ...
 *
 */
if (!function_exists('azrcrv_create_plugin_menu_tc')){
	function azrcrv_create_plugin_menu_tc(){
		azrcrv_create_plugin_menu_table_tc();
		azrcrv_populate_plugin_menu_table_tc();
	}
}
 ...
 *
 */
if (!function_exists('azrcrv_populate_plugin_menu_table_tc')){
	function azrcrv_populate_plugin_menu_table_tc(){
		global $wpdb;
 ...
 *
 */
if (!function_exists('azrcrv_create_plugin_menu_table_tc')){
	function azrcrv_create_plugin_menu_table_tc(){
		global $wpdb;
		$table_name = $wpdb->base_prefix.'azrcrv_plugin_menu';
