...
Download link:	https://github.com/azurecurve/azrcrv-tag-cloud/releases/download/v1.1.0/azrcrv-tag-cloud.zip
 ...
 * Download the plugin from [GitHub](https://github.com/azurecurve/azrcrv-tag-cloud/releases/latest/).
...
### [Version 1.0.1](https://github.com/azurecurve/azrcrv-tag-cloud/tree/v1.0.1)
 * Update azurecurve menu for easier maintenance.
 * Move require of azurecurve menu below security check.

### [Version 1.0.0](https://github.com/azurecurve/azrcrv-tag-cloud/tree/v1.0.0)
